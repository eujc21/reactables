    ...
    _this.appendPoints = function () {
      ...
      data.forEach(function (dataset, setIndex) {
        ...
        .on("mouseover", function (d, i) {
          ...
          _this.tooltipContainer.html((0, _common.renderTooltip)(tooltip, { dataset: dataset.name, data: d, index: i })).style("left", d3.event.pageX + "px").style("top", d3.event.pageY + "px");
