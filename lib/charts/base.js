...
var BaseChart = exports.BaseChart = function (_React$Component) {
  ...
  function BaseChart() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BaseChart.__proto__ || Object.getPrototypeOf(BaseChart)).call.apply(_ref, [this].concat(args))), _this), _this.generateChartID = function () {
    ...
    }, _this.makeResponsive = function (svg) {
      ...
      d3.select(window).on("resize." + _this.generateChartID(), resize);
    ...
    }, _this.appendTitle = function () {}, _this.appendXAxis = function () {}, _this.appendYAxis = function () {}, _this.renderChart = function () {
