...
var Table = function (_React$Component) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Table)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      ...
      var computedFields = _this$props2.computedFields;
      var controls = _this$props2.controls;


      return tableData.map(function (data, i) {
        //add computed fields
      ...
      var isSelectable = _this$props3.isSelectable;
      var selectedIndex = _this$props3.selectedIndex;
      var include = _this$props3.include;
      var exclude = _this$props3.exclude;
      ...
      var tableData = _this._addFields(_this.state.tableData);

      _this.setState({
        cellWidth: _this.getColumnWidths(tableData),
        tableData: tableData
      });
      ...
      console.log(_this.props.tableData, nextProps.tableData);

      var data = !_lodash2.default.isEqual(_this.props.tableData, nextProps.tableData) ? nextProps.tableData : _this.state.tableData;
      ...
      var isHoverable = _this$props4.isHoverable;
      var hoverColor = _this$props4.hoverColor;
      ...
      var isHoverable = _this$props5.isHoverable;
      var isStriped = _this$props5.isStriped;
      var stripeColor = _this$props5.stripeColor;
      var selectColor = _this$props5.selectColor;
      ...
      var isSelectable = _this$props6.isSelectable;
      var onRowClick = _this$props6.onRowClick;
      ...
      var onSort = _this$props7.onSort;
      var computedFields = _this$props7.computedFields;
        ...
        _react2.default.createElement(
          ...
          tableHeadings.map(function (heading, i) {
            return _react2.default.createElement(
              ...
              {
                key: i,
                style: Object.assign({}, style.thead.th, {
