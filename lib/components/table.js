...
export var Table = function (_React$Component) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Table.__proto__ || Object.getPrototypeOf(Table)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      tableData: _.cloneDeep(_this.props.tableData),
      ...
      var _this$props2 = _this.props,
          computedFields = _this$props2.computedFields,
      ...
      return tableData.map(function (data, i) {
        ...
        if (controls) {
          Object.keys(controls).forEach(function (key) {
            var control = _.isFunction(controls[key]) ? [controls[key]] : controls[key];
            data[key] = React.createElement(
              'div',
              { key: i },
      ...
      var _this$props3 = _this.props,
          ...
          include = _this$props3.include,
          exclude = _this$props3.exclude,
          columnOrder = _this$props3.columnOrder,
          headings = _this$props3.headings,
          isScrollable = _this$props3.isScrollable;
      var tableData = _this.state.tableData;

      var tableWidth = ReactDOM.findDOMNode(_this).clientWidth;
      ...
      var _this$props4 = _this.props,
          ...
          hoverColor = _this$props4.hoverColor;
      ...
      var _this$props5 = _this.props,
          isHoverable = _this$props5.isHoverable,
          isStriped = _this$props5.isStriped,
          stripeColor = _this$props5.stripeColor,
          selectColor = _this$props5.selectColor;
      ...
      var _this$props6 = _this.props,
          isSelectable = _this$props6.isSelectable,
      ...
      var _this$props7 = _this.props,
          onSort = _this$props7.onSort,
          computedFields = _this$props7.computedFields;
        ...
        React.createElement(
          ...
          tableHeadings.map(function (heading, i) {
            return React.createElement(
              ...
              lastKey === tableProperties[i] ? React.createElement('i', {
...
Table.propTypes = {
  ...
  controls: PropTypes.objectOf(PropTypes.oneOfType([PropTypes.func, PropTypes.array])),
  columnOrder: PropTypes.arrayOf(PropTypes.string),
  formatters: PropTypes.objectOf(PropTypes.func),
  computedFields: PropTypes.objectOf(PropTypes.func),
  headings: PropTypes.objectOf(PropTypes.oneOfType([PropTypes.string, PropTypes.object])),
