...
var LineChart = exports.LineChart = function (_React$Component) {
  ...
  function LineChart() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LineChart.__proto__ || Object.getPrototypeOf(LineChart)).call.apply(_ref, [this].concat(args))), _this), _this.handlePointClick = function (d, i) {
      ...
      svg.append('g').attr('transform', 'translate(0, ' + height + ')').call(xAxis).style('stroke-width', 0.5).selectAll('text').style('text-anchor', 'end').style('font-size', tickFontSize + 'px').attr('transform', 'rotate(-45)');
      ...
      data.forEach(function (dataset) {
        ...
        .on("mouseover", function (d, i) {
          ...
          div.html(_this.renderTooltipContent(d, i)).style("left", d3.event.pageX + "px").style("top", d3.event.pageY + "px");
        ...
        .on("click", _this.handlePointClick);
      });
