...
import { showElement, hideElement } from './element_loader_reducer';

var defaultTypeSuffixes = ['REQUEST', 'SUCCESS', 'FAILURE'];

export default function elementLoaderMiddleware() {
