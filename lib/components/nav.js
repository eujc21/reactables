...
var Nav = exports.Nav = function (_React$Component) {
  ...
  function Nav() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Nav.__proto__ || Object.getPrototypeOf(Nav)).call.apply(_ref, [this].concat(args))), _this), _this.state = { top: undefined }, _this.getTop = function (el) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        typeof to === 'string' ? _react2.default.createElement(
          'a',
          { style: styles.link, href: to },
          children
        ) : _react2.default.createElement(
          'a',
          { style: styles.link, href: '', onClick: to },
          children
        )
      );
    }
