...
var Input = exports.Input = function (_React$Component) {
  ...
  function Input() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Input.__proto__ || Object.getPrototypeOf(Input)).call.apply(_ref, [this].concat(args))), _this), _this.handleTextChange = function (e) {
