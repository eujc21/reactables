...
var DateTimePicker = exports.DateTimePicker = function (_React$Component) {
  ...
  function DateTimePicker() {
    ...
    }, _this.renderDatePicker = function (styles) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          isTimePicker ? _react2.default.createElement(_timepicker2.default, {
            date: startDate,
            onChange: _this.handleTimePickerStartChange,
            style: styles.timePicker
          }) : null
        ),
        isRangePicker ? _react2.default.createElement('div', { style: styles.verticalRule }) : null,
        isRangePicker ? _react2.default.createElement(
          'div',
          { style: styles.calendarContainer },
          _react2.default.createElement(
          ...
          isTimePicker ? _react2.default.createElement(_timepicker2.default, {
            date: endDate,
            onChange: _this.handleTimePickerEndChange,
            style: styles.timePicker
          }) : null
        ) : null
      );
  ...
  _createClass(DateTimePicker, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      this.setState({
        startDate: startDate ? startDate.utc() : null,
        endDate: endDate ? endDate.utc() : null,
        startMonth: startDate && !(0, _isEqual2.default)(this.props.startDate, startDate) ? startDate.clone().utc().startOf('month') : this.state.startMonth,
        endMonth: endDate && !(0, _isEqual2.default)(this.props.endDate, endDate) ? endDate.clone().utc().startOf('month') : this.state.endMonth
      });
    }
  }, {
