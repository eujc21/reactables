  ...
  _createClass(DateTimePicker, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      this.setState({
        ...
        endDate: endDate.utc(),
        startMonth: !(0, _isEqual2.default)(this.props.startDate, startDate) ? startDate.clone().utc().startOf('month') : this.state.startMonth,
        endMonth: !(0, _isEqual2.default)(this.props.endDate, endDate) ? endDate.clone().utc().startOf('month') : this.state.endMonth
      });
    }
  }, {
