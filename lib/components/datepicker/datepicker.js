...
var _dropdown_item = require('../dropdown/dropdown_item');
  ...
  _createClass(DatePicker, [{
    ...
    value: function renderYears() {
      ...
      var yearComponents = years.map(function (y) {
        return _react2.default.createElement(_dropdown_item.DropdownItem, {
          key: y,
          text: y,
      ...
      return [_react2.default.createElement(_dropdown_item.DropdownItem, {
        ...
        } })].concat(_toConsumableArray(yearComponents), [_react2.default.createElement(_dropdown_item.DropdownItem, {
        key: 'increment',
        text: '...',
        shouldHideMenu: false,
        onClick: function onClick() {
