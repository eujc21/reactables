...
var Button = exports.Button = function (_React$Component) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      if (isHovered) (0, _merge2.default)(styles.base, styles.hovered);
      if (isSelected) (0, _merge2.default)(styles.base, styles.selected);
      if (isDisabled) (0, _merge2.default)(styles.base, styles.disabled);
