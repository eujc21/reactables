...
var NavbarLink = function (_React$Component2) {
  ...
  _createClass(NavbarLink, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'li',
        { style: styles.base, onMouseEnter: this.handleHover, onMouseLeave: this.handleHover },
        typeof to === 'string' ? _react2.default.createElement(
          'a',
          { style: isMobile ? style.menuLink.base : styles.link.base, href: to },
          children
        ) : _react2.default.createElement(
          'a',
          { style: isMobile ? style.menuLink.base : styles.link.base, onClick: to },
          children
        )
      );
    }
