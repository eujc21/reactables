  ...
  _createClass(Navbar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: styles.base },
        isMobile ? this.renderMobile(children, styles) : this.renderDesktop(children, styles)
      );
    }
  }, {
    key: 'renderDesktop',
    value: function renderDesktop(children, styles) {
      var _this2 = this;

      var links = _react2.default.Children.toArray(children).reduce(function (obj, link) {
        var append = link.props.append;

        obj[append || 'left'].push(_react2.default.cloneElement(link, { isMobile: false }));
        return obj;
      }, { left: [], right: [] });
    ...
    key: 'renderMobile',
    value: function renderMobile(children, styles) {
      var _this3 = this;

      var links = _react2.default.Children.toArray(children).reduce(function (obj, link) {
        var appendResponsive = link.props.appendResponsive;

        obj[appendResponsive || 'menu'].push(_react2.default.cloneElement(link, { isMobile: appendResponsive !== 'bar' }));
        return obj;
      }, { bar: [], menu: [] });
...
var NavbarLink = function (_React$Component2) {
  ...
  function NavbarLink() {
    ...
    return _ret2 = (_temp2 = (_this4 = _possibleConstructorReturn(this, (_ref2 = NavbarLink.__proto__ || Object.getPrototypeOf(NavbarLink)).call.apply(_ref2, [this].concat(args))), _this4), _this4.state = { isHovered: false }, _this4.handleHover = function () {
    ...
    }, _this4.setLinkColor = function (styles) {
      ...
      if (isMobile) {
        if (isActive) (0, _merge2.default)(styles.menuLink.base, styles.menuLink.active);
        if (isHovered) (0, _merge2.default)(styles.menuLink.base, styles.menuLink.hover);
      } else {
        if (isActive) (0, _merge2.default)(styles.link.base, styles.link.active);
        if (isHovered) (0, _merge2.default)(styles.link.base, styles.link.hover);
      }

      return styles;
    }, _this4.renderLinkType = function (styles) {
      var _this4$props2 = _this4.props,
          children = _this4$props2.children,
          to = _this4$props2.to,
          isMobile = _this4$props2.isMobile;

      var linkStyle = isMobile ? styles.menuLink.base : styles.link.base;

      if (typeof to === 'string') return _react2.default.createElement(
        'a',
        {
          style: linkStyle,
          href: to
      ...
      if ((0, _isFunction2.default)(to)) return _react2.default.createElement(
        'a',
        {
          style: linkStyle,
          onClick: to
...
NavbarLink.propTypes = {
  ...
  to: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.func]),
